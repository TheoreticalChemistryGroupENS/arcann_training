...
DeepMD_FOUNDATION_FILE="_R_DEEPMD_FONDATION_FILE_"
...
dp --pt train ${DeepMD_IN_FILE} --finetune ${DeepMD_FOUNDATION_FILE} --log-path ${DeepMD_LOG_FILE} > ${DeepMD_OUT_FILE} 2>&1
